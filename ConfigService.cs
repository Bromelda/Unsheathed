...
internal static class ConfigService
{
    ...
    public static class ConfigInitialization
    {
        ...
        [
            ...
            new ConfigEntryDefinition("General", "TwilightArsenal", false, "Enable or disable experimental ability replacements on shadow weapons."),
            // --- Twilight Arsenal: data-driven overrides ---
            new ConfigEntryDefinition("General","Twilight_Loadout","FishingPole,Daggers,Reaper,Mace,Sword,GreatSword,Spear,TwinBlades,Slashers,Whip,Pistols,Crossbow,Longbow,Claws", "FishingPole,Daggers,Reaper,Mace,Sword,GreatSword,Spear,TwinBlades,Slashers,Whip,Pistols,Crossbow,Longbow,Claws."),
...
new ConfigEntryDefinition("General",
    ...
    " primary=AB_Fishing_AbilityGroup;q=AB_Bandit_Fisherman_SpinAttack_AbilityGroup;e=AB_Bandit_Fisherman_FishHook_AbilityGroup;copy=true,true,true",
     "FishingPole Prefab ability Format primary=prefab,q=prefab,e=prefab;copy=true,true,true"),

new ConfigEntryDefinition("General",
    "Twilight_Groups_Daggers","primary=1837385563;q=1971375367;e=211628325;copy=true,true,true",
    "Daggers Prefab ability Format primary=prefab,q=prefab,e=prefab;copy=true,true,true"),

new ConfigEntryDefinition("General",
    "Twilight_Groups_Reaper",
    "primary=948587795;q=-808864212;e=1691254929;copy=true,true,true",
    "Reaper Prefab ability Format primary=prefab,q=prefab,e=prefab;copy=true,true,true"),

new ConfigEntryDefinition("General",
    "Twilight_Groups_Mace",
    "primary=722599012;q=-1172099204;e=1926314891;copy=true,true,true",
    "Mace Prefab ability Format primary=prefab,q=prefab,e=prefab;copy=true,true,true"),

new ConfigEntryDefinition("General",
    "Twilight_Groups_Sword",
    "primary=-2097352908;q=532210332;e=-1161896955;copy=true,true,true",
    "Sword Prefab ability Format primary=prefab,q=prefab,e=prefab;copy=true,true,true"),

new ConfigEntryDefinition("General",
    "Twilight_Groups_GreatSword",
    "primary=-1428882023;q=-328302080;e=-2126197617;copy=true,true,true",
    "GreatSword Prefab ability Format primary=prefab,q=prefab,e=prefab;copy=true,true,true"),

new ConfigEntryDefinition("General",
    "Twilight_Groups_Spear",
    "primary=1142040823;q=381862924;e=1166337981;copy=true,true,true", 
    "Spear Prefab ability Format primary=prefab,q=prefab,e=prefab;copy=true,true,true"),

new ConfigEntryDefinition("General",
    "Twilight_Groups_TwinBlades",
    "primary=298784800;q=-2023636973;e=-1357375516 ;copy=true,true,true", 
    "TwinBlades Prefab ability Format primary=prefab,q=prefab,e=prefab;copy=true,true,true"),

new ConfigEntryDefinition("General",
    "Twilight_Groups_Slashers",
    "primary=-186690512;q=-198012170;e=2019689688;copy=true,true,true", 
    "Slashers Prefab ability Format primary=prefab,q=prefab,e=prefab;copy=true,true,true"),

new ConfigEntryDefinition("General",
    "Twilight_Groups_Whip",
    "primary=112329675;q=-1111373807;e=2130985273;copy=true,true,true",
    "Whip Prefab ability Format primary=prefab,q=prefab,e=prefab;copy=true,true,true"),

new ConfigEntryDefinition("General",
    "Twilight_Groups_Pistols",
    "primary=1622839653;q=-1884688827;e=-526118698;copy=true,true,true",  
    "Pistols Prefab ability Format primary=prefab,q=prefab,e=prefab;copy=true,true,true"),

new ConfigEntryDefinition("General",
    "Twilight_Groups_Crossbow",
    "primary=1232856473;q=76767983;e=-444905742;copy=true,true,true",  
    "Crossbow Prefab ability Format primary=prefab,q=prefab,e=prefab;copy=true,true,true"),

new ConfigEntryDefinition("General",
    "Twilight_Groups_Longbow",
    "primary=617823552;q=766284586;e=501615608;copy=true,true,true", 
    "Longbow Prefab ability Format primary=prefab,q=prefab,e=prefab;copy=true,true,true"),

new ConfigEntryDefinition("General",
    "Twilight_Groups_Claws",
    "primary=1180130515;q=-1085783726;e=-2096054164;copy=true,true,true", 
    "Claws Prefab ability Format primary=prefab,q=prefab,e=prefab;copy=true,true,true"),

            // --- Twilight: ability run script indices per weapon ---
...
new ConfigEntryDefinition(
    "General",
    "Twilight_Scripts_FishingPole",
    "-1,-5,-12", // default script indices for P,Q,E; use -1 to skip
    "Run script indices for FishingPole Twilight abilities as 'P,Q,E'. Use -1 to skip a slot."
),
new ConfigEntryDefinition(
    "General",
    "Twilight_Scripts_Daggers",
    "-1,5,12",
    "Run script indices for Daggers Twilight abilities as 'P,Q,E' (e.g., '2,7,7'). Use -1 to skip a slot."
),

            new ConfigEntryDefinition(
    "General",
    "Twilight_Scripts_Reaper",
    "6,5,5",
    "Run script indices for Reaper Twilight abilities as 'P,Q,E'. Use -1 to skip a slot."
),

            new ConfigEntryDefinition(
    "General",
    "Twilight_Scripts_Mace",
    "-1,-1,5",
    "Run script indices for Mace Twilight abilities as 'P,Q,E'. Use -1 to skip a slot."
),

            new ConfigEntryDefinition(
    "General",
    "Twilight_Scripts_Sword",
    "-1,8,15",
    "Run script indices for Sword Twilight abilities as 'P,Q,E'. Use -1 to skip a slot."
),

            new ConfigEntryDefinition(
    "General",
    "Twilight_Scripts_GreatSword",
    "-1,-1,5",
    "Run script indices for GreatSword Twilight abilities as 'P,Q,E'. Use -1 to skip a slot."
),

            new ConfigEntryDefinition(
    "General",
    "Twilight_Scripts_Spear",
    "-1,2,11",
    "Run script indices for Spear Twilight abilities as 'P,Q,E'. Use -1 to skip a slot."
),

            new ConfigEntryDefinition(
    "General",
    "Twilight_Scripts_TwinBlades",
    "-1,-1,6",
    "Run script indices for TwinBlades Twilight abilities as 'P,Q,E'. Use -1 to skip a slot."
),

            new ConfigEntryDefinition(
    "General",
    "Twilight_Scripts_Slashers",
    "-1,5,5",
    "Run script indices for Slashers Twilight abilities as 'P,Q,E'. Use -1 to skip a slot."
),

            new ConfigEntryDefinition(
    "General",
    "Twilight_Scripts_Whip",
    "5,2,4",
    "Run script indices for Whip Twilight abilities as 'P,Q,E'. Use -1 to skip a slot."
),

            new ConfigEntryDefinition(
    "General",
    "Twilight_Scripts_Pistols",
    "0,5,11",
    "Run script indices for Pistols Twilight abilities as 'P,Q,E'. Use -1 to skip a slot."
),

            new ConfigEntryDefinition(
    "General",
    "Twilight_Scripts_Crossbow",
    "3,7,7",
    "Run script indices for Crossbow Twilight abilities as 'P,Q,E'. Use -1 to skip a slot."
),
   

new ConfigEntryDefinition(
    "General",
    "Twilight_Scripts_Longbow",
    "-1,5,7",
    "Run script indices for Longbow Twilight abilities as 'P,Q,E'. Use -1 to skip a slot."
),

            new ConfigEntryDefinition(
    "General",
    "Twilight_Scripts_Claws",
    "-1,5,5",
    "Run script indices for Claws Twilight abilities as 'P,Q,E'. Use -1 to skip a slot."
),
